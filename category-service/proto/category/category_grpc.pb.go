...
func (c *categoryServiceClient) GetCategoryByID(ctx context.Context, in *GetCategoryRequest, opts ...grpc.CallOption) (*CategoryResponse, error) {
...
func (UnimplementedCategoryServiceServer) GetCategoryByID(context.Context, *GetCategoryRequest) (*CategoryResponse, error) {
